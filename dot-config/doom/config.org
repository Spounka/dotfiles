...
(use-package! treesit
:hook ((python-mode . (lambda () (treesit-parser-create 'python)))
       (c-mode . (lambda () (treesit-parser-create 'c)))
       (c++-mode . (lambda () (treesit-parser-create 'cpp))))
  :config
...
(add-hook 'c-ts-mode-hook 'my/treesit-custom-highlighting)
(add-hook 'c++-ts-mode-hook 'my/treesit-custom-highlighting)
...
(defun my/treesit-enhanced-highlighting ()
  "Enhanced Tree-sitter-based font-lock for distinguishing between variables, functions, and constants."
  (setq-local treesit-font-lock-settings
              (append treesit-font-lock-settings
                      '(
                        ...
                        ;; Highlight member variables (fields)
                        ((field_expression) @member-variable
                         (:override t :face font-lock-type-face))

                        ;; Highlight function/method calls
                        ((call_expression function: (identifier) @function-call)
                         (:override t :face font-lock-function-name-face))

                        ;; Highlight constants
                        ((constant_declaration) @constant
                         (:override t :face font-lock-constant-face))
...
;; Add hooks for the relevant major modes
(add-hook 'c-mode-hook 'my/treesit-enhanced-highlighting)
(add-hook 'c++-mode-hook 'my/treesit-enhanced-highlighting)
(add-hook 'python-mode-hook 'my/treesit-enhanced-highlighting)
(add-hook 'c-ts-mode-hook 'my/treesit-enhanced-highlighting)
(add-hook 'c++-ts-mode-hook 'my/treesit-enhanced-highlighting)
(add-hook 'python-ts-mode-hook 'my/treesit-enhanced-highlighting)
